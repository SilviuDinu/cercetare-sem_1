...
export default function IndividualPatientData(props) {
    return (
        <props.wrapper title={props.wrapper === "tr" ? "Open " + props.data.id : null} onClick={props.openFile ? (event) => props.openFile(props.data) : null} className={props.display ? props.display : null}>
            ...
            <PatientSymptomsData data={props.data} tag={props.children} />
